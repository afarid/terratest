...
import (
	...
	"github.com/afarid/terratest/modules/files"
	"github.com/afarid/terratest/modules/git"
)
...
func TestDownloadPolicyDownloadsRemote(t *testing.T) {
	...
	baseDir := fmt.Sprintf("git::https://github.com/afarid/terratest.git?ref=%s", curRef)
	localPath := "../../examples/terraform-opa-example/policy/enforce_source.rego"
	remotePath := fmt.Sprintf("git::https://github.com/afarid/terratest.git//examples/terraform-opa-example/policy/enforce_source.rego?ref=%s", curRef)
...
func TestDownloadPolicyReusesCachedDir(t *testing.T) {
	...
	baseDir := "git::https://github.com/afarid/terratest.git?ref=master"
	remotePath := "git::https://github.com/afarid/terratest.git//examples/terraform-opa-example/policy/enforce_source.rego?ref=master"
	remotePathAltSubPath := "git::https://github.com/afarid/terratest.git//modules/opa/eval.go?ref=master"
